...
#---- read image ----
image = cv2.imread('./computer vision/camus.jpg')
...
def show_detected_images(img,bbox_ids,all_bounding_boxes,class_ids,confidence_values,width_ratio,height_ratio):
...
cv2.imshow('YOLOV3 Algorithm',image)
cv2.waitKey()
